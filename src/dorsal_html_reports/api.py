...
from dorsal_html_reports.generator import (
...
def generate_html_file_report(
    ...
    try:
        ...
        local_fs_info = {
            "record_id": local_attrs.get("record_id") or local_attrs.get("instance_id") or file_data.get("record_id", ""),
...
def generate_html_directory_report(
    ...
    try:
        if enabled_panels is None:
            enabled_panels = [
                "summary_stats", "collection_overview", "duplicates_report", 
                "dynamic_size_histogram", "file_explorer"
            ]
